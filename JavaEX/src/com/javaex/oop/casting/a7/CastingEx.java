...
public class CastingEx {
	...
	dog2.eat();
	dog2.walk();
	//dog2.bark();  //참조타입의 설계도 안에 있는 것만 이용할 수 있다. //그러나 강아지니까 짓게 해주자 
	//참조타입을 자기자신으로 변경해주자 dog2를 Dog로 변환해 주자  (다운캐스팅)
	((Dog)dog2).bark();  //Dog로 바꾸기  
	
	
	//애완동물을 기르고 있었다. 아지키우고 있음-산책시키고 멕이고 - 아지가 죽음 /새 애완동물기름  - 고양이기르자- 멕이고 산책다니고 /
    ...
    //((Dog)cat).bark(); 안된다.	//	cat 인스턴스는 Dog 클래스의 인스턴스가 아니다
